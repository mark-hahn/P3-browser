    ...
    <div class="network-page-pane-body">
      <form action="" v-show="isVisible">
        ...
        <table>
          ...
          <tr>
            <td><input v-model.trim="ssids[0].apSsid"></td>
            <td><input type="password" v-model.trim="ssids[0].apPwd"></td>
          </tr>
        </table>
        ...
        <table>
          ...
          <tr v-for="(ssid,idx) of ssids" v-if="idx>0">
            <td><input v-model.trim="ssid.ssid">  </td>
            <td><input type="password" v-model.trim="ssid.password"> </td>
          </tr>
        </table>
